<header class="global">
  ...
  <nav class="primary">
    <ul>
      ...
      <li class="candidates">
                <a href="http://careers.futurestep.com" title="Find out about the different ways to contact Futurestep" target="new">Find a job <span class="decoration sprite right-arrow-grey"><span>&gt;</span></span></a></li>
    </ul>
  </nav>
