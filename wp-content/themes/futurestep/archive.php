...
$year = ($_GET['yearreq']=='') ? date('Y') : $_GET['yearreq'];
            ...
            <section class="detail">
                ...
                <section class="press-releases">
                    <h1><?php echo $post_type; ?></h1>
                        <ul class="year-index">
                             <li<?php if($year==2011) echo ' class="current"'; ?>><a href="<?php get_permalink(); ?>?yearreq=2011">2011</a></li>
                             <li<?php if($year==2010) echo ' class="current"'; ?>><a href="<?php get_permalink(); ?>?yearreq=2010">2010</a></li>
                             <li<?php if($year==2009) echo ' class="current"'; ?>><a href="<?php get_permalink(); ?>?yearreq=2009">2009</a></li>
                             <li<?php if($year==2008) echo ' class="current"'; ?>><a href="<?php get_permalink(); ?>?yearreq=2008">2008</a></li>
                        </ul>
            <!-- -->
<?php
