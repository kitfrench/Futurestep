  ...
  <div class="butterflies-tall-pattern">
    <section class="core-content about-us-container">
      <section class="detail">
        <nav class="index">
          <ul>
            <li class="selected"><a href="<?php echo get_permalink(icl_object_id(38, 'page')); ?>"><?php echo icl_t('Contact', 'Global offices', 'Global offices'); ?></a></li>
            <li class="last-item"><a href="<?php echo get_permalink(icl_object_id(303, 'page')); ?>"><?php echo icl_t('Contact', 'Find an Expert', 'Find an Expert'); ?></a></li>
          </ul>
        </nav>
        ...
        <div class="filter">
          <form action="<?php echo get_permalink(icl_object_id(38, 'page')); ?>" method="post">
            <label>
              <span style="vertical-align: baseline;" class="filter-label"><?php echo icl_t('Contact', 'Filter by Region', 'Filter by Region'); ?></span>
            ...
            <input type="submit" name="find-office" value="<?php echo icl_t('Search button', 'Search', 'Search'); ?>" class="button"/>
          </form>
        </div>
              ...
              <li>
                ...
                <div class="vcard">
                  ...
                  <p class="adr">
                    ...
                    <span>Phone: <span class="tel"><?php echo get_post_meta(get_the_ID(), 'office-address-phone', true) ?></span></span>
                  </p>
