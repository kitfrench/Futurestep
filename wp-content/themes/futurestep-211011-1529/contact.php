  ...
  <div class="butterflies-tall-pattern">
      ...
      <section class="detail">
        ...
        <div class="filter">
          <form action="/contact-us" method="post">
            <label>
              <span style="vertical-align: baseline;" class="filter-label">Filter by Region</span>
            ...
            $args = array( 'taxonomy' => 'category-region' );
                ...
                <option
                <?php if($contactregionsearch==$term->name) echo 'selected="selected" ';
                ?>value="<?php echo $term->
    ...
    $args = array( 'taxonomy' => 'category-region', 'posts_per_page' => 1000);
          ...
          <div title="Office Locations in <?php echo $term->name ?>" class="territory">
            ...
            <ul class="experts">
              <?php
            $args = array( 'post_type' => 'locations', 'category-region' => $term->name, 'orderby' => 'title', 'order' => 'ASC');
          ...
          <div title="Office Locations in <?php echo $contactregionsearch; ?>" class="territory">
            <h1><?php echo $contactregionsearch; ?></h1>

            <ul>
              <?php
            $args = array( 'post_type' => 'locations', 'category-region' => $contactregionsearch, 'orderby' => 'title', 'order' => 'ASC');
              $loop = new WP_Query( $args );
