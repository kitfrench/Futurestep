	...
	yoast_breadcrumb(&#x27;&lt;p id=&quot;breadcrumbs&quot;&gt;&#x27;,&#x27;&lt;/p&gt;&#x27;);
		...
		function files_page() {
			if ( isset($_POST['submitrobots']) ) {
				if (!current_user_can('level_7')) die(__('You cannot edit the robots.txt file.', 'yoast-wpseo'));
			...
			if ( isset($_POST['submithtaccess']) ) {
				if (!current_user_can('level_7')) die(__('You cannot edit the .htaccess file.', 'yoast-wpseo'));
