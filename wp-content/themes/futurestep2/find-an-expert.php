    ...
    <section class="core-content about-us-container">
        <section class="detail">
            ...
            <section class="body">
                ...
                <ul class="experts">
<?php
            $args = array( 'post_type' => 'experts', 'sector' => $_POST['sector'], 'country' => $_POST['country'], 'service' => $_POST['service']);
            ...
            while ( $loop->have_posts() ) : $loop->the_post(); ?>
                <li class="member">
                        ...
                        <p>
                            ...
                            <span class="position"><?php echo get_post_meta(get_the_ID(), 'expert-postion', true) ?></span>
          ...
          <?php 
            ...
            foreach($terms as $term) :  ?>
                    <option <?php if($_POST['solution']==$term->name) echo 'selected="selected" '; ?>value="<?php echo $term->name; ?>"><?php echo $term->name; ?></option>
          <?php  endforeach; ?>
                </select>
                </label>
